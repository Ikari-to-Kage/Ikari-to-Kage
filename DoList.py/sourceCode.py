...
header_label = ttk.Label(  
    header_frame,     text = "The To-Do List",font = ("Brush Script MT", "30"),  
    background = "#FAEBD7",      foreground = "#8B4513"  
)  
...
task_label = ttk.Label(  
    functions_frame,text = "Enter the Task:",font = ("Consolas", "11", "bold"),  
    background = "#FAEBD7",  
    foreground = "#000000"  
)  
...
task_field = ttk.Entry(  
    functions_frame,    font = ("Consolas", "12"),  
    width = 18,      background = "#FFF8DC",  
)  
...
task_listbox = tk.Listbox(  
    listbox_frame,  
    width = 35,     # Actually the height.
    height = 15,    # Actually the width.
    selectmode = 'SINGLE', 
    #   Text box style. 
    background = "#EEEEEE", #BG 
    foreground = "#580000", #Text
    #   Text box hover.
